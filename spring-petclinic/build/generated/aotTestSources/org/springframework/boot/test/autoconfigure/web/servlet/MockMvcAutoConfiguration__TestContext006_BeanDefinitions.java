 ...
 */
public class MockMvcAutoConfiguration__TestContext006_BeanDefinitions {
  /**
  ...
  private static BeanInstanceSupplier<DispatcherServletPath> getDispatcherServletPathInstanceSupplier(
    ...
    return BeanInstanceSupplier.<DispatcherServletPath>forFactoryMethod(MockMvcAutoConfiguration.class, "dispatcherServletPath")
            .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean(MockMvcAutoConfiguration.class).dispatcherServletPath());
  }
  ...
  public static BeanDefinition getDispatcherServletPathBeanDefinition() {
    Class<?> beanType = DispatcherServletPath.class;
    RootBeanDefinition beanDefinition = new RootBeanDefinition(beanType);
  ...
  private static BeanInstanceSupplier<DispatcherServlet> getDispatcherServletInstanceSupplier() {
    return BeanInstanceSupplier.<DispatcherServlet>forFactoryMethod(MockMvcAutoConfiguration.class, "dispatcherServlet", MockMvc.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean(MockMvcAutoConfiguration.class).dispatcherServlet(args.get(0)));
  }
