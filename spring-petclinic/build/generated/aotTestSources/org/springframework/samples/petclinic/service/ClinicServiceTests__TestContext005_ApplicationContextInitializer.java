 ...
 */
public class ClinicServiceTests__TestContext005_ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new ClinicServiceTests__TestContext005_BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new ClinicServiceTests__TestContext005_BeanFactoryRegistrations().registerAliases(beanFactory);
  }
